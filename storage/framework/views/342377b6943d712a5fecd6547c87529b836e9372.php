                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" action="<?php echo e(route('clients.store')); ?>">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="payment_term" class="form-control"
                                            placeholder="Payment Term" autocomplete="off" required>
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <span class="fas fa-user"></span>
                                            </div>
        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-block btn-danger btn-flat" data-toggle="modal"
                    data-target="#modal-default" data-placement="top" rel="tooltip" title="Add Client">
                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill"
                                ...
                                aria-selected="false">Has Debt</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel"
                            ...
                            <table id="asc_first_column1" class="table table-bordered table-striped text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> <?php echo e($client->name_short); ?> </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    href="<?php echo e(route('generate_billing_statement', $client->id)); ?>" data-placement="top"
                                                    rel="tooltip" title="Billing Statement for <?php echo e($client->name_short); ?>">
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    href="<?php echo e(route('clients.edit', $client->id)); ?>" data-placement="top"
                                                    rel="tooltip" title="Edit <?php echo e($client->name_short); ?>"
                                                ...
                                                <a class="btn btn-danger btn-sm delete"
                                                    href="<?php echo e(route('clients.soft_delete', $client->id)); ?> "
                                                    data-placement="top" rel="tooltip"
                                                    title="Delete <?php echo e($client->name_short); ?>" data-original-title="soft ">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    href="<?php echo e(route('generate_billing_statement', $client->id)); ?>" data-placement="top"
                                                    rel="tooltip" title="Bill <?php echo e($client->name_short); ?>">
