        ...
        <li class="nav-item dropdown user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    <a href="<?php echo e(route('purchases.index')); ?>" class="btn btn-warning btn-flat float-left"
                        data-placement="bottom" rel="tooltip" title="Receive Orders">
                        <i class="fa fa-truck"></i>
                    </a>
                    <a href="<?php echo e(route('payments')); ?>" class="btn btn-warning btn-flat float-left"
                    ...
                    <a href="<?php echo e(route('logout')); ?>" class="btn btn-warning btn-flat float-right"
...
<?php /**PATH C:\xampp\htdocs\laravel\laravel_erp\resources\views/partials/header.blade.php ENDPATH**/ ?>