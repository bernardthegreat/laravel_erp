...
<body style="font-family: sans-serif">
  ...
  <div>
    ...
    <table id="body" style="width: 100%;border-collapse: collapse; text-align: center;">
      ...
      <tbody>
        <?php $__currentLoopData = $sales_print; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
...
</body><?php /**PATH C:\xampp\htdocs\laravel\laravel_erp\resources\views/analytics/sales/monthly_sales_income.blade.php ENDPATH**/ ?>