        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview"
               ...
               with font-awesome or any other icon font library -->
                ...
                <!-- <li class="nav-item">
                    <a href="<?php echo e(route('inventory_dashboard')); ?>" class="nav-link active">
...
<?php /**PATH C:\xampp\htdocs\laravel\laravel_erp\resources\views/partials/nav.blade.php ENDPATH**/ ?>