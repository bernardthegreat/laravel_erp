                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-6 border-right">
                                <div class="description-block">
                                    <h5 class="description-header">
                                        <a href="/clients/{{$client->id}}/edit" class="btn btn-block btn-danger btn-flat" data-placement="top" rel="tooltip" title="View Client">
                            ...
                            <div class="col-sm-6">
                                <div class="description-block">
                                    <h5 class="description-header">
                                        <a href="/sales/create/{{$client->id}}" class="btn btn-block btn-danger btn-flat" data-placement="top" rel="tooltip" title="Sell to this Client">
