      ...
      <table id="example1" class="table table-bordered table-striped text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <a class="btn btn-danger btn-sm" href="{{ route('suppliers.edit', $supplier->id)}}" data-placement="top"
                  rel="tooltip" title="Edit {{$supplier->name_short}}" data-original-title="Edit">
                  <i class="fa fa-edit">
                  </i>
                </a>
                <a class="btn btn-danger btn-sm delete" href="{{ route('suppliers.soft_delete', $supplier->id)}} "
                  data-placement="top" rel="tooltip" title="Delete {{$supplier->name_short}}"
