      ...
      <form role="form" method="post" action="{{ route('interests.update', $interests->id) }}">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="qty_from" id="qty_from" value="{{$interests->qty_from}}"
              autocomplete="off">
          </div>

          <div class="form-group">
            <label for="qty_from">Quantity To</label>
            <input type="text" class="form-control" name="qty_to" id="qty_to" value="{{$interests->qty_to}}"
              autocomplete="off">
          </div>

          <div class="form-group">
            <label for="rate">Rate</label>
            <input type="text" class="form-control" name="rate" id="rate" value="{{$interests->rate}}"
              autocomplete="off">
          </div>
