      ...
      <table id="example1" class="table table-bordered table-striped text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <a class="btn btn-danger btn-sm" href="{{ route('items.edit', $item->id)}}" data-placement="top"
                  rel="tooltip" title="Edit {{$item->name_long}}" data-original-title="Edit">
                  <i class="fa fa-edit">
                  </i>
                </a>
                <a class="btn btn-danger btn-sm delete" href="{{ route('items.soft_delete', $item->id)}} "
                  data-placement="top" rel="tooltip" title="Delete {{$item->name_long}}" data-original-title="soft ">
                  <i class="fa fa-trash">
                  </i>
                </a>
              </div>
