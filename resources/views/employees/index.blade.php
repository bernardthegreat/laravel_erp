                                            ...
                                            <table id="example3" class="table table-bordered table-striped text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            @if(isset($attendance_employee->from_time))
                                                                {{ date('h:i:s A', strtotime($attendance_employee->from_time)) }} 
                                                            @endif
                                                        </td>
                                                        <td> 
                                                            @if(isset($attendance_employee->to_time))
                                                                {{ date('h:i:s A', strtotime($attendance_employee->to_time)) }} 
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    @endforeach
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route('generate_latest_payslip', $employee->id)}}" target="_blank"
                                    data-placement="top" rel="tooltip" title="Print Latest Payslip of {{$employee->fullname}}"
