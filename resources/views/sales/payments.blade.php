                                        ...
                                        <td> 
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-danger btn-sm process_payment_btn" href="#"
                                                    data-dr-number="{{$sale->dr_no ?? ''}}"
                                                    data-invoice-number="{{$sale->invoice_no ?? ''}}"
                                                    data-url="{{ route('process_payment') }}"
                                                    data-toggle="modal"
                                                    data-target="#modal-default" data-placement="top"
                                                    data-placement="top" rel="tooltip" title="Mark as Paid DR # {{$sale->invoice_no}}"
